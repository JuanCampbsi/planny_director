...
let IFaseState;
let ICorredorState;
let IisOpenOrDisable;
let IConteudoAnaliseCritica;
let IConteudoItems;
let IAllGroups;
let ITiposConteudoState;
const initialState = {
    listModulo: [],
    listCorredor: [],
    listComplexo: [],
...
export const { itemOpenToogleClosed, itemOpenToogleMultiSelectComplexo, itemOpenToogleMultiSelectFase, itemsIsChartValueContent, itemsFilterOpenToogle, itemsAddModulo, itemsAddCorredor, itemsAddComplexo, itemsAddFase, itemsAddCiclo, itemsAddInformativos, itemsAddInformativosLabel, setListFilter, setListFilterCiclo, setListFilterComplexo, setListFilterCorredor, setListFilterFase, setIsOpenOrDisable, setListFilterModulo, setIsContextRouterModulo, setIsConteudoAnaliseCritica, setListFiltred, setFilterComplexos, setFilterComplexosArray, setFilterFaseArray, setAllGroupsEdicaoSelected, setAllGroupsLeituraSelected, setItemsAddInformativosCentral, clearFilterFaseArray, clearFilterComplexosArray, clearAllComplexosSelected, clearAllFasesSelected, setIsOpenOrDisableModalSucessOrError, setCicloCurrent, setTiposConteudo, setListFilterTiposConteudo, setListMenuItems, setListGroupsTeamEdicao, setListGroupsTeamLeitura, clearGroupsTeamEdicao, clearGroupsTeamLeitura, setGraphicsImages, } = state.actions;
