...
export class UserProfileClassService {
    constructor() {
        ...
        this.getGroupsInfoCurrentUser = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const perms1 = yield sp.web.currentUserHasPermissions(PermissionKind.AddListItems);
            const perms2 = yield sp.web.currentUserHasPermissions(PermissionKind.EditListItems);
