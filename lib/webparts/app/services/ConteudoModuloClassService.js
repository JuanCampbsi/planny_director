    ...
    constructor() {
        this.getConteudoByFilter = (filters) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield sp.web.lists
                ...
                .items.select('Id', 'Title', 'Modified', '*,Modulo/Nome,Modulo/Id', '*,Corredor/Id,Corredor/Nome', '*,Complexo/Id,Complexo/Nome,Corredor', '*,Fase/Id,Fase/Nome', '*,Ciclo/Id,Ciclo/Nome,Ciclo/Title', '*,TiposConteudo/Id,TiposConteudo/Title', 'URLConteudo', 'AnaliseCritica', 'GruposEdicao/Title', 'GruposLeitura/Title', '*,TiposConteudo/Id, TiposConteudo/Title')
            ...
            groupsEdicao === null || groupsEdicao === void 0 ? void 0 : groupsEdicao.map((item) => this.addConteudoEdicao(item));
            groupsLeitura === null || groupsLeitura === void 0 ? void 0 : groupsLeitura.map((item) => this.addConteudoLeitura(item));
            return mapGetItemsConteudoModulo(result);
        });
        this.addConteudoEdicao = (id) => __awaiter(this, void 0, void 0, function* () {
            const infoGroupsEdicao = yield sp.web.siteGroups.getById(id).users.get();
        ...
        this.addConteudoLeitura = (id) => __awaiter(this, void 0, void 0, function* () {
            const infoGroupsLeitura = yield sp.web.siteGroups.getById(id).users.get();
        ...
        this.addFileToFolder = (file, filters, id) => __awaiter(this, void 0, void 0, function* () {
            ...
            const folderExist = yield lib.rootFolder.folders.getByName(`${filters.modulo.Nome}`).folders();
            if (folderExist.length === 0) {
                const newFolder = yield lib.rootFolder.folders.getByName(`${filters.modulo.Nome}`).addSubFolderUsingPath(`Ciclo_${filters.ciclo.Title}`);
            }
            if (folderExist.length > 0) {
        ...
        this.editFileToFolder = (file, filters, id) => __awaiter(this, void 0, void 0, function* () {
            const rename = `Id-${id}_ConteudoModulo.pdf`;
            const fileUpdate = yield sp.web
