    ...
    constructor() {
        this.getItemsAllModulo = () => __awaiter(this, void 0, void 0, function* () {
            const result = yield sp.web.lists
                ...
                .items.select('Id', 'Author/Title', 'Nome', 'Created', 'Modified', 'Icone', 'ConteudoTema', 'TipoModulo', 'OrdemImpressao', 'TiposConteudo/Title', 'TiposConteudo/Id')
                .expand('Author', 'TiposConteudo')
                .orderBy('OrdemImpressao', true)
                .get();
        ...
        this.getItemsWithLimit = (top = 100) => __awaiter(this, void 0, void 0, function* () {
            const result = yield sp.web.lists
                .getByTitle(this._list)
                .items.select('Id', 'Author/Title', 'Nome', 'OrdemImpressao', 'Created', 'Modified', 'Icone', 'Corredor/Created', 'Corredor/Modified', 'Corredor/Id', 'Corredor/Nome', 'CorredorId', 'ConteudoTema', 'TipoModulo')
        ...
        this.createModulos = (moduloInput) => {
            this.addModulo(moduloInput)
                ...
                const modulo = {
                    Id: response.Id,
                    OrdemImpressao: response.OrdemImpressao,
                    Nome: response.Nome,
                    ...
                    TiposConteudo: response.TiposConteudo,
                };
