...
export declare class ConteudoModuloClassService {
    ...
    addConteudoEdicao: (id: number) => Promise<void>;
    addConteudoLeitura: (id: number) => Promise<void>;
    addFileToFolder: (file: any, filters: IFilter, id?: number) => Promise<import("@pnp/sp/files").IFileAddResult>;
    editFileToFolder: (file: any, filters: IFilter, id?: number) => Promise<import("@pnp/sp/files").IFileAddResult>;
    addConteudoModulo: (item: any) => Promise<import("@pnp/sp/items/types").IItemAddResult>;
    editConteudoModulo: (id: number, moduloInput: any) => Promise<void>;
