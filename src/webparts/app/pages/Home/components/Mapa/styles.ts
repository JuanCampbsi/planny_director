...
export const CicloElipse = styled.div<ClicleElipseProps>`
  width: 4.3125rem;
  height: 4.3125rem;
  cursor: pointer;
...
export const Left = styled.img<ButtonProps>`
  width: 2.125rem;
  height: 4.3125rem;
...
export const Right = styled.img<ButtonProps>`
  width: 2.125rem;
  height: 4.3125rem;
  display: ${({ isActive }) => (isActive ? 'block' : 'none')};
`;
